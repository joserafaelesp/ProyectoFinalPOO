	...
	public LaEmpresa() {
		...
		itemAgregarTrabajador.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				AgregarTrabajador agregarTrabajador = new AgregarTrabajador(null, false);
				agregarTrabajador.setModal(true);
				agregarTrabajador.setVisible(true);
				*/
			}
		});
		itemAgregarTrabajador.setIcon(new ImageIcon(LaEmpresa.class.getResource("/imagenes/registrarTrabajador.png")));
